...
exports.formatPromptReport = formatPromptReport;
...
function selectorLabel(finding) {
    return finding.selector ? `\`${finding.selector}\`` : `"${finding.targetName}"`;
}
function fixInstruction(finding) {
...
function formatPromptReport(findings, figmaLink, url) {
...
//# sourceMappingURL=prompt-reporter.js.map